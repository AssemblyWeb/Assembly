<div id="section1" class="homepage-hero-module relative">
    <div class="video-container">
      <div class="filter">

      </div>
      <div class="header-logo z-2 absolute">
        <img id="hero-logo" src="img/logo_w.svg" class="img-responsive img-center hero-logo" />
        <h1 id="hero-text" class="header-text marginTop-40 z-2 text-center">Assembling the web through design</h1>
      </div>
